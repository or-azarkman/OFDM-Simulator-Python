...
- **Summary (after running comparison scripts):** Comparison table (`results/summary/comparison_table.csv`, `.md`); BER comparison plots (AWGN vs Multipath, 500 vs 5000, ZF vs MMSE); constellation comparison (4×3 grid: AWGN, Multipath no eq, ZF, MMSE × 0/10/20 dB). Generated by `plot_ber_comparison.py` and `plot_constellation_comparison.py`. Commands: `docs/RUN_AND_TEST.md`.
